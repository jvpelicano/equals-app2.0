    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton_filterJobTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(PWD_AvailableJobs_2_OrthopedicDisability.this, autoComplete_filterJobTitles.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        refUser.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot pwd_dataSnapshot) {
                ...
                //Query query_filterToSkillCategory = refForJobs.orderByChild("skillCategory").equalTo(autoComplete_filterSkillOrDisability.getText().toString());
